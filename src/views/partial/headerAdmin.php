   ...
   <div class="header__bottom">
      ...
      <div class="header__bottom--navbar">
           <ul class="bottom__navbar">
                ...
                <li>  <a href="http://localhost:8080/project--ttu/admin/addgroup"> Quản trị danh sách nhóm tin </a>  </li>
                <li>  <a href="http://localhost:8080/project--ttu/admin/addnews"> Quản trị danh sách bản tin </a>  </li>
